...
if __name__ == "__main__":
    ...
    pdf_path=r"/Users/prabhatkumarjena/Desktop/prabhat-learning-repo/code/gen-ai-projects/document-portal/data/document_analysis/NIPS-2017-attention-is-all-you-need-Paper.pdf"
    class DummnyFile:
